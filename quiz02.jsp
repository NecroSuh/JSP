...
<body>
	<form action="company.html">
		<table>
			<tr>
				<td colspan="2">다음 <span style="background-color: peru;"><b>
				내용에 맞게 입력</b></span> 하시오.
				</td>
				<td rowspan="5"><img src="test.jpg" width="200px"height="150px">
				</td>
			</tr>
			<tr>
				<td colspan="2"><label>전공 분야를 입력하세요.</label>
			...
			<tr>
				<td colspan="3">
					<fieldset style="width: 500">
						<legend>성별 조사</legend>
						여성 <input type="radio" name="gender" checked>
			...
			<tr>
				<td colspan="3"><input type="submit" value="완료">
